                    ...
                    <form role="form" method="POST" action="/projetos/{{ $projeto->id }}" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" onkeypress="return /[A-Za-z\s]/i.test(event.key)" required value="{{ empty(old('inputDesig')) ? $projeto->designacao : old('inputDesig')  }}" name="inputDesig" id="inputDesig"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" required value="{{ empty(old('inputResp')) ? $projeto->responsavel : old('inputResp')  }}" id="inputResp" name="inputResp"
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" required value="{{ empty(old('inputData')) ? $projeto->dataInicio : old('inputData')  }}" id="inputData" name="inputData">
                                @error('inputData')
                                <p class="text-danger">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" required value="{{ empty(old('inputGit')) ? $projeto->github : old('inputGit')  }}" id="inputGit" name="inputGit"
